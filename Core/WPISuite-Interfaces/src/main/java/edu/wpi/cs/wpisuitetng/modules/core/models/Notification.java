...
/**
 * The Data Model representation of a notification request. The client
 * generates this structure and sends it to /WPISuite/API/Email in order to
 * email notification messages to other users.
 */
public class Notification extends AbstractModel {
     ...
     * representation
     * 
     * @param json a JSON representation of the message
     * @return
     */
