...
public class Icons {
    ...
    public final static Icon CALENDAR = new ImageIcon(Icons.class.getResource("calendar.png"));
    public final static Icon CANCEL = new ImageIcon(Icons.class.getResource("cancel.png"));
    ...
    public final static Icon FILTER = new ImageIcon(Icons.class.getResource("filter4.png"));
}
