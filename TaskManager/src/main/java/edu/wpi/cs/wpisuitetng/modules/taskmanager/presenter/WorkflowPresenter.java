...
public class WorkflowPresenter {
    ...
    public WorkflowPresenter(int workflowId) {
        ...
        view = new WorkflowView("Loading...");
        manageView = new ManageBucketsPanel(model);
        registerCallbacks();
    }
    ...
    public String idToBucketName(int id) {
        return bucketPresenters.get(id).getModel().getTitle();
    }
    ...
    public void registerCallbacks() {
         ...
         * tab.
         */
        manageView.addCloseButtonListener(new ActionListener() {
            @Override
         ...
         */
        manageView.addAddBucketButtonListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
         ...
         * SCREEN
         */
        manageView.addDeleteBucketButtonListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
         ...
         */
        manageView.addMoveBucketUpButtonListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int currentIndex = manageView.getBucketListIndex();
         ...
         */
        manageView.addMoveBucketDownButtonListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int currentIndex = manageView.getBucketListIndex();
                int currentId = model.getBucketIds().get(currentIndex);
         ...
         */
        manageView.addSetInitBucketButtonListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int currentIndex = manageView.getBucketListIndex();
