...
public class ToolbarView extends JPanel {
    ...
    public ToolbarView() {
        ...
        JButton createNewTaskButton = new JButton(
                "<html>Create<br/>Task</html>");
        ...
        createNewTaskButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                TaskPresenter taskPresenter = new TaskPresenter(0, MainView
                        ...
                        .getBucketPresenterById(1), ViewMode.CREATING);
        ...
        JToggleButton tglbtnArchive = new JToggleButton(
                "<html>Hide<br/>Archived</html>");
