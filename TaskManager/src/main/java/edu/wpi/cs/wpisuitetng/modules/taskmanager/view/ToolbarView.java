...
public class ToolbarView extends JPanel
{
    ...
    public ToolbarView() {
        ...
        DocumentListener startDateListener = new DocumentListener() {
            ...
            public void changedUpdate(DocumentEvent e) {
                ...
                filterStartDatePicker.getMonthView().setUpperBound(
                        getUpperDateBound());
                MainView.getInstance().setFilterStartDate(
            ...
            public void removeUpdate(DocumentEvent e) {
                ...
                filterStartDatePicker.getMonthView().setUpperBound(
                        getUpperDateBound());
                MainView.getInstance().setFilterStartDate(null);
        ...
        DocumentListener endDateListener = new DocumentListener() {
            ...
            public void changedUpdate(DocumentEvent e) {
                filterEndDatePicker.getMonthView().setLowerBound(
                        getLowerDateBound());
                MainView.getInstance().setFilterEndDate(
            ...
            public void removeUpdate(DocumentEvent e) {
                filterEndDatePicker.getMonthView().setLowerBound(
                        getLowerDateBound());
                MainView.getInstance().setFilterEndDate(null);
        ...
        filterByText.getDocument().addDocumentListener(new DocumentListener() {
            ...
            @Override
            public void changedUpdate(DocumentEvent e) {
                MainView.getInstance().setFilterText(filterByText.getText());
                MainView.getInstance().resetAllBuckets();
        ...
        filterByUser.getDocument().addDocumentListener(new DocumentListener() {
            ...
            @Override
            public void changedUpdate(DocumentEvent e) {
                MainView.getInstance().setFilterUser(filterByUser.getText());
                MainView.getInstance().resetAllBuckets();
            }
