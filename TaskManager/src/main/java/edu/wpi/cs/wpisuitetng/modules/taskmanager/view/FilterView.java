...
/**
 * An Expandable and Collapsible panel which holds all filtering options and
 * elements for the Task Manager.
 * 
...
public class FilterView extends JPanel {
    ...
    private Color colorsFilterOptions[] = { new Color(238, 238, 238),
            Color.WHITE, Color.YELLOW, Color.RED, Color.GREEN, Color.MAGENTA,
            Color.GRAY };
    ...
    private JComboBox<Color> filterColorComboBox = new JComboBox<Color>(
            colorsFilterOptions);
    ...
    public FilterView() {
        ...
        dateHolderPanel
                .add(startDateFilterLabel, "flowx,cell 2 0,alignx right");
        dateHolderPanel.add(endDateFilterLabel,
                "flowx,cell 2 1,alignx trailing");
    ...
    public void registerCallbacks() {
        DocumentListener startDateListener = new DocumentListener() {
            ...
            @Override
            /*
             * allows any due date before latest and takes limit off latest due
             * date
             */
        ...
        DocumentListener endDateListener = new DocumentListener() {
            ...
            @Override
            /*
             * allows any due date after earliest and takes limit off earliest
             * due date
             */
            public void removeUpdate(DocumentEvent e) {
                filterEndDatePicker.getMonthView().setLowerBound(
        ...
        filterByText.getDocument().addDocumentListener(new DocumentListener() {
            ...
            @Override
            public void changedUpdate(DocumentEvent e) {
                BucketPresenter.getTaskFilter().setFilterText(
                        filterByText.getText());
                MainView.getInstance().resetAllBuckets();
        ...
        filterByUser.getDocument().addDocumentListener(new DocumentListener() {
             ...
             */
            public void changedUpdate(DocumentEvent e) {
                BucketPresenter.getTaskFilter().setFilterUser(
                        filterByUser.getText());
                MainView.getInstance().resetAllBuckets();
            }
     ...
     *            highest date allowed by start date
     */
