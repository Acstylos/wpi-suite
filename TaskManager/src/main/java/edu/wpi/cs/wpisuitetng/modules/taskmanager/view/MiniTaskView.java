...
public class MiniTaskView extends JPanel {
    ...
    public MiniTaskView(TaskModel model) {
        ...
        holderPanel.setMinimumSize(new Dimension(50, 10));
        colorPanel.setMinimumSize(new Dimension(10, 15));
        holderPanel.add(colorPanel, "dock north");
        taskNameLabel.setBorder(new EmptyBorder(8, 8, 8, 8));
        taskNameLabel.setIcon(Icons.TASKNEW);
        ...
        taskNameLabel.addMouseMotionListener(dragAdapter);

        userPanel.setLayout(new MigLayout("fill"));
        userScrollPane
                .setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        userScrollPane.setBorder(new TitledBorder(null, "Assigned Users",
    ...
    public void setColorHighlighted(boolean highlighted) {
        ...
        holderPanel.setBackground(background);
    ...
    public void addUsersToUserPanel(List<String> userList) {
        ...
        for (String name : userList) {
            ...
            userPanel.add(userLabel, "dock north");
        }
    }
    ...
    public void addOnClickOpenExpandedView(MouseListener listener) {
        ...
        taskNameLabel.addMouseListener(listener);
        userPanel.addMouseListener(listener);
        userScrollPane.addMouseListener(listener);
    }
    ...
    public void setModel(TaskModel model) {
        ...
        if (this.model.getIsArchived()) {
            taskNameLabel.setText(this.model.getTitle() + " (archived)");
        } else {
            taskNameLabel.setText(this.model.getTitle());
        }
        taskNameLabel.setToolTipText(this.model.getTitle());
