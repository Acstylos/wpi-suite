...
public class TaskPresenter {
    ...
    public void setModel(TaskModel model) {
        ...
        for (int i : model.getActivityIds()) {
            ...
            p.load();
            p.getModel().setActivity("WHAT THE SHIT!!!!");
            activityPresenters.add(p);
        }
        System.out.println("Size of getActivityIds(): "
                + model.getActivityIds().size());
        System.out.println("Size of activityPresenters: "
                + activityPresenters.size());
    }
