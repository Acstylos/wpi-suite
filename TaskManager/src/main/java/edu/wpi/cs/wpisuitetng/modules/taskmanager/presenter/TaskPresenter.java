...
public class TaskPresenter {
    ...
    public void updateBeforeModel() {
        ...
        beforeModel.setRequirements(model.getRequirements());
    }
    ...
    /**
     * add all requirements' names to list of all requirements names
     * @param reqs
     */
    public void addRequirementsToAllReqName(Requirement[] reqs) {
        for (Requirement req: reqs) {
            allReqName.add(req.getName());
        }
    }
