...
public class TaskPresenter {
    ...
    private List<String>  allReqName = new ArrayList<String>();
    ...
    private void registerCallbacks() {
        ...
        view.addRequirementButtonListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                //System.out.println(reqMap.get(view.getRequirement()-1));
                //System.out.println(ViewEventController.getInstance().getListOfRequirementPanels());
                ViewEventController.getInstance().editRequirement(reqMap.get(view.getRequirement()-1));
            }
    ...
    /**
     * @return  The List String of requirement Names
     */
    ...
    public void updateModel() {
        ...
        model.setRequirement(view.getRequirement());
