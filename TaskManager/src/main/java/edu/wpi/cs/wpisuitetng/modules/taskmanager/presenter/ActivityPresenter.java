...
public class ActivityPresenter {
    ...
    public void load() {
	HttpMethod method;
	String id = "/" + model.getActivityId();
	if (model.getActivityId() == 0) { // Put = create a new model
	...
	this.model.setActivityId(activityId);
	saveModel();
    }
