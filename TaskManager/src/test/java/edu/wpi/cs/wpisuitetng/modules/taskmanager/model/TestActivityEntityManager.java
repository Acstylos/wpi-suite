...
public class TestActivityEntityManager {
	    ...
	    public void testGetEntity() throws WPISuiteException {
	    	testUser = new User("joe", "joe", "1234", 2);
	        testUser.setRole(Role.ADMIN);
	        manager.save(defaultSession, new ActivityModel(2, testUser,"comment1", new Date(4, 12, 2014)));
	        manager.save(defaultSession, new ActivityModel(3, testUser,"comment2", new Date()));
	        manager.save(defaultSession, new ActivityModel(4, testUser,"comment3", new Date()));
